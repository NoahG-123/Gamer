...
export function resetDb(): void {
  const conn = db();
  conn.exec("DELETE FROM events; DELETE FROM flags; DELETE FROM fired_triggers; DELETE FROM revealed; DELETE FROM messages; DELETE FROM chat_meta; DELETE FROM browser_history; DELETE FROM kv;");
}
